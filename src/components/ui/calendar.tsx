  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        caption: "flex justify-center pt-3 relative items-center mb-2",
        caption_label: "text-base sm:text-lg font-medium text-white",
        nav: "space-x-1 flex items-center",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-8 w-8 sm:h-9 sm:w-9 bg-black/30 border border-white/10 p-0 text-white hover:bg-white/10 hover:text-white hover:border-white/20"
        ),
        ...
        head_row: "flex",
        head_cell:
          "text-white rounded-md w-8 sm:w-9 font-normal text-[0.8rem] sm:text-[0.9rem]",
